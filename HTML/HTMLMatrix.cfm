...
<cfinclude template="/Library/jQuery/jQueryUI.css.cfm">
<link rel="stylesheet" type="text/css" href="/Library/CSS/thSort.css"/>
<link rel="stylesheet" type="text/css" href="/Library/jQuery/Icons/Icons.css"/>
<link rel="stylesheet" type="text/css" href="/Library/jQuery/superfish/css/superfish.css" media="screen">
<link rel="stylesheet" type="text/css" href="HTMLMatrix.css"/>
...
<div>
	<table id="matrix" class="border thSort icons">
		<thead>
		<tr>
			<th width="183" scope="col">Category</th>
			<th width="86" scope="col">Usage</th>
			<th width="153" scope="col">
				<div class="floatleft">HTML</div>
				<div class="floatright ui-state-default ui-corner-all">
					<span class="ui-icon ui-icon-circle-triangle-n"></span>
				</div>
			</th>		
			<th width="697" scope="col">Explanation</th>
			<th width="350" scope="col">Notes</th>
		</tr>
		</thead>
		<tbody>
		<tr>
...
<script src="/Library/jQuery/Icons/Icons.js"></script>
<script src="/Library/jQuery/hoverIntent.js"></script> 
<script src="/Library/jQuery/superfish/js/superfish.js"></script> 
<script src="HTMLMatrix.js"></script>
<script src="../Matrix/Index.js"></script>
